...
savedBlindAveragePercent = loadTextFile("averageBlindPercent.txt")
	...
	if savedBlindCurrentAttempt == nil then
		...
		currentAttempt = savedBlindCurrentAttempt + 1
		savetoCurrentAttemptFile(currentAttempt)
	end
	...
	if savedBlindTotalAttempt == nil then
		...
		totalAttempt = savedBlindTotalAttempt + 1
		savetoTotalAttemptFile(totalAttempt)
	end
...
local function goToFail()
	...
	composer.gotoScene("blindFail", "fade", 800)
...
savedBlindCurrentAttempt = loadTextFile("currentBlindAttempt.txt")
		...
		if savedBlindBestAttempt == 0 then
				bestAttempt = savedBlindCurrentAttempt
				savetoBestAttemptFile(bestAttempt)
			else if tonumber(savedBlindBestAttempt) > tonumber(savedBlindCurrentAttempt) then
					bestAttempt = savedBlindCurrentAttempt
					savetoBestAttemptFile(bestAttempt)
			end
		end
		...
		if currentAttempt == 1 then
			firstAttempt = savedBlindFirstAttempt + 1
			savetoFirstAttemptFile(firstAttempt)
		end
		
		completions = savedBlindCompletions + 1
		savetoCompletionsFile(completions)
		currentAttempt = 0
		savetoCurrentAttemptFile(currentAttempt)
		currentPercent = 100
		savetoCurrentPercentFile(currentPercent)
		greenBlock.isVisible = false
	composer.gotoScene("blind100Percent", "fade", 800)
...
local function onFinishLineCollision(event)
	...
	blindMessage = display.newText( "Same level just blind!", 240, 40, "native.systemFontBold", 19 )
	blindMessage:setFillColor( 0.0, 0.7, 0.9 )
	blindMessage.direction = "Up"
	physics.addBody( blindMessage, { isSensor= true, density= 30, friction=0.1, bounce=0 } )
	blindMessage.gravityScale = -0.1
	sceneGroup:insert(blindMessage)
...
--[
	...
	orangeTriangle.isVisible = false
	...
	orangeTriangle2.isVisible = false
	...
	orangeTriangle3.isVisible = false
	...
	orangeTriangle4.isVisible = false
	...
	orangeTriangle11.isVisible = false
	...
	orangeTriangle12.isVisible = false
	...
	orangeTriangle5.isVisible = false
	...
	orangeTriangle6.isVisible = false
	...
	orangeTriangle7.isVisible = false
	...
	orangeTriangle8.isVisible = false
	...
	orangeTriangle9.isVisible = false
	...
	orangeTriangle10.isVisible = false
	...
	orangeTriangle13.isVisible = false
	...
	orangeTriangle14.isVisible = false
	...
	orangeTriangle15.isVisible = false
	...
	orangeTriangle16.isVisible = false
	...
	orangeTriangle18.isVisible = false
	...
	orangeTriangle19.isVisible = false
	...
	orangeTriangle20.isVisible = false
	...
	orangeTriangle21.isVisible = false
	...
	orangeTriangle22.isVisible = false
	...
	orangeTriangle23.isVisible = false
	...
	orangeTriangle24.isVisible = false
	...
	orangeTriangle25.isVisible = false
	...
	orangeTriangle26.isVisible = false
	...
	orangeTriangle17.isVisible = false
	...
	orangeTriangle27.isVisible = false
	...
	orangeTriangle28.isVisible = false
	...
	orangeTriangle29.isVisible = false
	...
	orangeTriangle30.isVisible = false
	...
	orangeTriangle31.isVisible = false
	...
	orangeTriangle32.isVisible = false
	...
	orangeTriangle33.isVisible = false
	...
	orangeTriangle34.isVisible = false
	...
	orangeTriangle35.isVisible = false
	...
	orangeTriangle36.isVisible = false
	...
	orangeTriangle37.isVisible = false
	...
	orangeTriangle38.isVisible = false
	...
	orangeTriangle39.isVisible = false
	...
	orangeTriangle40.isVisible = false
	...
	orangeTriangle41.isVisible = false
	...
	orangeTriangle42.isVisible = false
	...
	orangeTriangle43.isVisible = false
	...
	orangeTriangle44.isVisible = false
	...
	orangeTriangle45.isVisible = false
	...
	orangeTriangle46.isVisible = false
	...
	orangeTriangle47.isVisible = false
	...
	orangeTriangle48.isVisible = false
	...
	orangeTriangle49.isVisible = false
	...
	orangeTriangle50.isVisible = false
	...
	orangeTriangle51.isVisible = false
	...
	orangeTriangle52.isVisible = false
...
--]]	
	...
	cheaterBlock10.isVisible = false
	...
	cheaterBlock11.isVisible = false
	...
	cheaterBlock12.isVisible = false
	...
	cheaterBlock13.isVisible = false
	...
	cheaterBlock14.isVisible = false
	...
	cheaterBlock15.isVisible = false
	...
	cheaterBlock16.isVisible = false
	...
	cheaterBlock17.isVisible = false
	...
	cheaterBlock18.isVisible = false
	...
	cheaterBlock19.isVisible = false
	...
	cheaterBlock20.isVisible = false
	...
	cheaterBlock21.isVisible = false
	...
	cheaterBlock22.isVisible = false
	...
	cheaterBlock23.isVisible = false
	...
	cheaterBlock24.isVisible = false
	...
	cheaterBlock25.isVisible = false
	...
	cheaterBlock26.isVisible = false
	...
	cheaterBlock27.isVisible = false
	...
	cheaterBlock28.isVisible = false
	...
	cheaterBlock29.isVisible = false
	...
	cheaterBlock30.isVisible = false
	...
	cheaterBlock31.isVisible = false
	...
	cheaterBlock32.isVisible = false
	...
	cheaterBlock33.isVisible = false
	...
	cheaterBlock34.isVisible = false
...
function scene:hide( event )
	...
	if savedBlindCurrentPercent ~= 100 then
	...
	if savedBlindCurrentPercent > savedBlindBestPercent then
		savetoBestPercentFile(savedBlindCurrentPercent)
	end
	
end
	
	totalPercent = savedBlindCurrentPercent + savedBlindTotalPercent
	savetoTotalPercentFile(totalPercent)
