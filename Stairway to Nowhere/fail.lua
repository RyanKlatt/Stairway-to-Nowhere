...
function scene:create( event )
	...
	percent = display.newText( "You completed "..tostring(savedCurrentPercent ).."% of the level!", 240, 160, "native.systemFontBold", 24 )
	percent:setFillColor( 1.0, 1.0, 1.0 )
	
	attemptNumber = display.newText( "This was attempt # "..tostring(loadedCurrentAttempt ), 240, 190, "native.systemFontBold", 24 )
